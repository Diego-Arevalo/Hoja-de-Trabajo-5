...
/*Dada la categor�a, zona, tipo y el �rea del terreno o inmueble
 determine a cu�nto asciende el monto que deber� pagar para comprar el inmueble */
void calculo(){
	int 	zcategoria;
	int 	zzona;
	int 	ztipo;
...
por categor�a, zona y tipo de inmueble*/
